...
public class Holonomic extends OpMode {
    ...
    public void start(){
        ...
        offsetZ = angles.firstAngle;
        offsetY = angles.secondAngle;
        offsetX = angles.thirdAngle;
    }
    ...
    public void loop(){
        ...
        telemetry.addData("Heading ", angles.firstAngle- offsetZ);
        ...
        double targetAngle = Math.atan2(leftY, leftX) - (Math.toRadians(angles.firstAngle- offsetZ));
